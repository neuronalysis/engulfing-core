...
String.prototype.ordinalize||(String.prototype.ordinalize=function(){var a;a=this.split(" ");for(var b=0;b<a.length;b++)if(NaN===parseInt(a[b])){var c=a[b].substring(a[b].length-2),d=a[b].substring(a[b].length-1),e="th";"11"!=c&&"12"!=c&&"13"!=c&&("1"===d?e="st":"2"===d?e="nd":"3"===d&&(e="rd"));a[b]+=e}return a=a.join(" ")});