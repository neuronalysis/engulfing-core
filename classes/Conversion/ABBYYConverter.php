<?php
class ABBYYConverter extends Converter {
    var $debugMode = false;
    
    function convertPDFToAltoXML() {
        ...
        $applicationId = 'ontologydriven';
        // Password should be sent to your e-mail after application was created
        $password = 'RGgmIYLoNUrWOvGNpUustNCs';
        ...
        $local_directory = "c:/xampp/htdocs/api/data/extraction/debug/downloads";
        ...
        $url = $serviceUrl.'/processImage?language=german&exportFormat=alto';
